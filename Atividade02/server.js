...
const server = http.createServer((request, response) => {
  ...
  const routes = { '/': 'login.html', '/login': 'login.html', '/conta': 'conta.html', '/frete': 'frete.html', '/senha': 'senha.html' };
...
server.listen(port, '127.0.0.1', () => console.log(`Aplicação disponível em http://127.0.0.1:${port}`));
